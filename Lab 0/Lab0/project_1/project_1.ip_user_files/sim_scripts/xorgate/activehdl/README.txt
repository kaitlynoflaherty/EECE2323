...
#
# Generated by export_simulation on Tue Jul 05 10:10:51 -0400 2022
#
################################################################################
...
'-reset_run' switch to the './xorgate.sh' script.

./xorgate.sh -reset_run
...
./xorgate.sh -noclean_files

For more information on the script, please type './xorgate.sh -help'.
