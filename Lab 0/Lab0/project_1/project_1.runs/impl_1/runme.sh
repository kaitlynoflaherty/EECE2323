...
HD_PWD='C:/Users/toure.o/Desktop/Lab0/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log xorgate_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source xorgate_wrapper.tcl -notrace
