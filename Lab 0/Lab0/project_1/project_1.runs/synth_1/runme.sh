...
HD_PWD='C:/Users/toure.o/Desktop/Lab0/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xorgate_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xorgate_wrapper.tcl
