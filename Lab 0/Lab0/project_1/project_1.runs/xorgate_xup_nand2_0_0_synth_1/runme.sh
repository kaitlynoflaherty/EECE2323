...
HD_PWD='C:/Users/toure.o/Desktop/Lab0/project_1/project_1.runs/xorgate_xup_nand2_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xorgate_xup_nand2_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xorgate_xup_nand2_0_0.tcl
