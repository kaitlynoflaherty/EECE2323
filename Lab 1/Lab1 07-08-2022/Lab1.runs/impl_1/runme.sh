...
HD_PWD='C:/Users/toure.o/Desktop/Lab1/Lab1/Lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adder8_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adder8_top.tcl -notrace
