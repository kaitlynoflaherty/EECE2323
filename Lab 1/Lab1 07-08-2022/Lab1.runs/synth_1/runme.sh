...
HD_PWD='C:/Users/toure.o/Desktop/Lab1/Lab1/Lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder8_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder8_top.tcl
