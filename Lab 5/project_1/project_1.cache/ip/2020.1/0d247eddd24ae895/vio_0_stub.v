...
/* synthesis syn_black_box black_box_pad_pin="clk,probe_in0[0:0],probe_in1[8:0],probe_in2[7:0],probe_in3[7:0],probe_in4[7:0],probe_in5[7:0],probe_in6[0:0],probe_in7[0:0],probe_in8[7:0],probe_in9[8:0],probe_out0[0:0],probe_out1[7:0],probe_out2[0:0],probe_out3[0:0],probe_out4[2:0],probe_out5[0:0],probe_out6[0:0],probe_out7[1:0],probe_out8[1:0],probe_out9[1:0]" */;
  input clk;
  input [0:0]probe_in0;
  input [8:0]probe_in1;
  input [7:0]probe_in2;
