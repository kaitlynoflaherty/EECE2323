...
begin
  ...
  qspo(1) <= \<const0>\;
  qspo(0) <= \<const0>\;
  spo(15 downto 5) <= \^spo\(15 downto 5);
  spo(4) <= \^spo\(5);
  spo(3) <= \^spo\(5);
  spo(2) <= \^spo\(2);
  spo(1) <= \^spo\(5);
...
\synth_options.dist_mem_inst\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_dist_mem_gen_v8_0_13_synth
     port map (
      a(7 downto 0) => a(7 downto 0),
      spo(11 downto 2) => \^spo\(15 downto 6),
      spo(1) => \^spo\(2),
      spo(0) => \^spo\(0)
    );
end STRUCTURE;
